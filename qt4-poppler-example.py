...
class PdfViewer(QWidget):
    ...
    def cacheImage(self, idx, force=None):
        ...
        width = float(height) * (float(page.pageSize().width())
...
if __name__ == '__main__':
    ...
    ex = PdfViewer(QtCore.QRect(0, 0, 1000, 1000))
    ex.load("/home/popolit/random-papers/"
            + "DBOSS-identification-of-the-givental-formula"
            + "-with-the-spectral-curve-topological-recursion"
            + "-procedure.pdf")
    ex.start()
    sys.exit(app.exec_())
